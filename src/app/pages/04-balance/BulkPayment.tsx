                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="appearance-none rounded-full pl-3 pr-7 text-[11px] font-bold font-sans normal-case text-slate-700 border border-slate-200 bg-white hover:bg-slate-50 transition-all shadow-2xs h-6.5 focus:outline-none cursor-pointer"
                          >
                            <option value="10" className="text-xs font-medium text-slate-800 bg-white font-sans normal-case">10 dòng</option>
                            <option value="50" className="text-xs font-medium text-slate-800 bg-white font-sans normal-case">50 dòng</option>
                            <option value="100" className="text-xs font-medium text-slate-800 bg-white font-sans normal-case">100 dòng</option>
                            <option value="all" className="text-xs font-medium text-slate-800 bg-white font-sans normal-case">Tất cả</option>
                          </select>
